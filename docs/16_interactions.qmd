# When we think our effect may be conditional on something else
...
box::use(
    ...
    modelsummary[modelsummary], # for regression table
    marginaleffects[plot_predictions], # for regression plot
    visreg[visreg] # alternative regression plot
)
# Load data
