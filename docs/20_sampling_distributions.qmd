...
What does this all look like when I do non-random samples? Does ***The Central Limit Theorem*** fix the problems coming from any single non-random sample that I've collected (like the one from the [previous exercise](19_sample_distribution.qmd)). A bit of a preview: no, it doesn't fix your problems.
