...
```
For the most part, the data in this class are quite "clean". However, there are circumstances where you might want to "clean" the variables some more. By "clean", I mean usable.
